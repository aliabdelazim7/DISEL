...
const PERM_GROUPS: { section: string; items: [string, string][] }[] = [
  { section: 'عام', items: [['/admin/overview', 'نظرة عامة'], ['/admin/daily-sales', 'مبيعات اليوم'], ['/admin/analytics', 'التحليلات والتقارير'], ['/admin/reports', 'التقارير وكشوف الحساب']] },
  // عروض الأسعار والأقساط موجودين في السايدبار من زمان بس كانوا ناقصين هنا،
  // يعني ما كانش ينفع تديهم لأي مستخدم غير المالك.
  { section: 'المبيعات والفواتير', items: [['/admin/invoices', 'الفواتير والمرتجعات'], ['/admin/quotations', 'عروض الأسعار'], ['/admin/installments', 'فواتير الأقساط والتحصيل'], ['/admin/offline-invoices', 'الفواتير الأوفلاين'], ['/admin/coupons', 'كوبونات الخصم']] },
