...
import { LayoutDashboard, Package, Settings, LogOut, FileText, Users, BarChart3, Wallet, MessageCircle, CreditCard, Building2, BellRing, WifiOff, Ticket, PieChart, Briefcase, Handshake, PiggyBank, ClipboardCheck, FileBarChart, Menu, X, CalendarClock, CalendarDays } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const navGroups = [
    { section: 'عام', items: [
      ...
      { name: 'مبيعات اليوم', path: '/admin/daily-sales', icon: CalendarDays },
