...
// ============================================================================
import type { OrderItem, Product } from '../store/useStore';

// الخدمة مالهاش مخزون ولا سعر شراء — بتتخزن بمخزون وهمي كبير عشان ما "تخلصش".
// يعني أي شاشة بتتعامل مع المخزون (مشتريات / جرد / نواقص) لازم تستبعدها،
// وإلا هتطلع أرقام بلا معنى (جرد لخدمة، أو شراء خدمة من مورد).
export const isServiceProduct = (p?: Pick<Product, 'type'> | null) => p?.type === 'service';
